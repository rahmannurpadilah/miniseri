    ...
    <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-2">
        ...
        <li class="dropdown-notifications-list scrollable-container">
            ...
            <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                ...
                <div class="flex-shrink-0 me-3">
                    <div class="avatar">
                    <img src="{{ asset('assets/vuexy/img/avatars/2.png') }}" alt class="rounded-circle" />
                    </div>
                </div>
                <div class="flex-grow-1">
            ...
            <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                ...
                <div class="flex-shrink-0 me-3">
                    <div class="avatar">
                    <img src="{{ asset('assets/vuexy/img/avatars/9.png') }}" alt class="rounded-circle" />
                    </div>
                </div>
                <div class="flex-grow-1">
            ...
            <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                ...
                <div class="flex-shrink-0 me-3">
                    <div class="avatar">
                    <img src="{{ asset('assets/vuexy/img/avatars/5.png') }}" alt class="rounded-circle" />
                    </div>
                </div>
                <div class="flex-grow-1">
            ...
            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                ...
                <div class="flex-shrink-0 me-3">
                    <div class="avatar">
                    <img src="{{ asset('assets/vuexy/img/avatars/6.png') }}" alt class="rounded-circle" />
                    </div>
                </div>
                <div class="flex-grow-1">
