    ...
    public function run(): void
    {
        $folio = [
            [
                ...
                'desc_home' =>
                    'Kisah pertemuan singkat yang mengubah cara dua orang memandang arti pulang.',

                // DESKRIPSI SEDANG (SAMPING TRAILER)
                'desc_side' =>
                    'Sebuah pertemuan singkat di waktu yang tidak terduga membawa dua orang pada makna baru tentang rumah dan perasaan yang tertinggal.',

                // DESKRIPSI PANJANG (BAWAH TRAILER)
                'desc_full' =>
                    "Langit Senja bercerita tentang dua individu yang dipertemukan kembali dalam waktu yang sangat singkat.\n\n" .
            ...
            [
                ...
                'desc_home' =>
                    'Ketegangan muncul saat sebuah rahasia terungkap hanya dalam hitungan menit.',

                'desc_side' =>
                    'Dalam situasi yang semakin menekan, setiap detik menjadi penentu antara kebenaran dan konsekuensi.',

                'desc_full' =>
                    "Detik Terakhir adalah film bergenre thriller yang berfokus pada satu momen krusial dalam hidup seorang tokoh.\n\n" .
            ...
            [
                ...
                'desc_home' =>
                    'Cerita tentang mimpi, kegagalan, dan harapan di dunia perfilman independen.',

                'desc_side' =>
                    'Perjalanan para pembuat film yang berjuang di balik layar untuk mewujudkan mimpi mereka.',

                'desc_full' =>
                    "Di Balik Layar mengisahkan kehidupan para sineas independen yang berjuang dengan keterbatasan dan tekanan industri.\n\n" .
